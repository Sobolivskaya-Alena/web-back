...
$number = (preg_replace('/\D/', '',  isset($_POST['number']) ? $_POST['number'] : ''));
...
function val_empty($cookis, $val, $name, $flag){
  if(empty($val)){
    setcookie($cookies.'_error', $name, time()+24*60*60);
    $error=true;
    $res=true;
  }
  return $res;
...
$db = new PDO('mysql:host=localhost;dbname=u67360', 'u67360', '4232624',
